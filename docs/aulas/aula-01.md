...
## 🎯 Objetivos da Aula
- [ ] Compreender os conceitos de Introdução às Estruturas de Dados
...
!!! info "O que é?"
    Breve explicação sobre Introdução às Estruturas de Dados.
...
int main() {
    printf("Exemplo de Introdução às Estruturas de Dados\n");
    return 0;
}
```
...
$ ./programa
Exemplo de Introdução às Estruturas de Dados
```
