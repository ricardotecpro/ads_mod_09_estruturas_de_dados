...
## 🎯 Objetivos da Aula
- [ ] Compreender os conceitos de Árvores – Conceitos Básicos
...
!!! info "O que é?"
    Breve explicação sobre Árvores – Conceitos Básicos.
...
int main() {
    printf("Exemplo de Árvores – Conceitos Básicos\n");
    return 0;
}
```
...
$ ./programa
Exemplo de Árvores – Conceitos Básicos
```
