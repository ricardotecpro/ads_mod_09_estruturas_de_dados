...
## 🎯 Objetivos da Aula
- [ ] Compreender os conceitos de Listas Duplamente Encadeadas
...
!!! info "O que é?"
    Breve explicação sobre Listas Duplamente Encadeadas.
...
int main() {
    printf("Exemplo de Listas Duplamente Encadeadas\n");
    return 0;
}
```
...
$ ./programa
Exemplo de Listas Duplamente Encadeadas
```
